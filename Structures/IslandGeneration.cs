        ...
        public void Generate(bool isRand)
        {
            ...
            switch (islandType)
            {
                ...
                case 0:
                    ...
                    WorldUtils.Gen(point5, new Shapes.Rectangle(islandWidth, WorldGen.genRand.Next(15, islandHeight)), Actions.Chain(new Modifiers.Blotches(WorldGen.genRand.Next(2, 6), 0.6), new Actions.SetTile(0), new Actions.SetFrames(frameNeighbors: true).Output(shapeData)));
