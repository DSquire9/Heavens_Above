        ...
        public void Generate(bool isRand)
        {
            ...
            switch (islandType)
            {
                ...
                case 0:
                    ...
                    WorldUtils.Gen(point, new Shapes.Slime(islandRadius, islandScale, WorldGen.genRand.Next(1, 3) * 0.6), Actions.Chain(new Modifiers.Blotches(WorldGen.genRand.Next(2, 6), 0.6), new Actions.SetTile((ushort)ModContent.TileType<Heavens_Above.Content.Tiles.AetherDirt>()), new Actions.SetFrames(frameNeighbors: true).Output(shapeData)));
                    WorldUtils.Gen(point, new ModShapes.OuterOutline(shapeData), Actions.Chain(new Actions.SetTile((ushort)ModContent.TileType<Heavens_Above.Content.Tiles.AetherGrass>()), new Actions.SetFrames(frameNeighbors: true)));
                    ...
                    WorldUtils.Gen(point5, new Shapes.Rectangle(islandWidth, WorldGen.genRand.Next(15, islandHeight)), Actions.Chain(new Modifiers.Blotches(WorldGen.genRand.Next(2, 6), 0.6), new Actions.SetTile((ushort)ModContent.TileType<Heavens_Above.Content.Tiles.AetherStone>()), new Actions.SetFrames(frameNeighbors: true).Output(shapeData)));
                ...
                case 1:
                    ...
                    WorldUtils.Gen(point5, new Shapes.Rectangle(islandWidth, WorldGen.genRand.Next(45, islandHeight)), Actions.Chain(new Modifiers.Blotches(WorldGen.genRand.Next(2, 6), 0.6), new Actions.SetTile((ushort)ModContent.TileType<Heavens_Above.Content.Tiles.AetherStone>()), new Actions.SetFrames(frameNeighbors: true).Output(shapeData)));
                ...
                default:
                    ...
                    WorldUtils.Gen(point5, new Shapes.Rectangle(islandWidth, WorldGen.genRand.Next(40, 70)), Actions.Chain(new Modifiers.Blotches(WorldGen.genRand.Next(2, 6), 0.6), new Actions.SetTile((ushort)ModContent.TileType<Heavens_Above.Content.Tiles.AetherStone>()), new Actions.SetFrames(frameNeighbors: true).Output(shapeData)));
