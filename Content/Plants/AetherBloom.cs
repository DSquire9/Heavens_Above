...
namespace HeavensAbove.Content.Plants
{
    ...
    public class AetherBloom : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            TileObjectData.newTile.AnchorValidTiles = new int[] {
                ModContent.TileType<Tiles.AetherGrass>()
            };
        ...
        public override IEnumerable<Item> GetItemDrops(int i, int j)
        {
            ...
            int herbItemType = ModContent.ItemType<Items.AetherBloom>();
            int herbItemStack = 1;

            int seedItemType = ModContent.ItemType<Items.AetherBloomSeeds>();
            int seedItemStack = 1;
