...
namespace HeavensAbove.Conent.Bosses
{
	...
	{
		public static bool downedSunSpirit = false;
		// public static bool downedOtherBoss = false;

		public override void ClearWorld() {
			downedSunSpirit = false;
		...
		public override void LoadWorldData(TagCompound tag) {
			downedSunSpirit = tag.ContainsKey("downedSunSpirit");
